...
"use strict";var Account=React.createClass({displayName:"Account",getInitialState:function(){return{user:"user1"}},render:function(){return this.props.user?React.createElement("div",{className:"form"},"You are logged in as ",React.createElement("b",null,this.props.user),"  ",React.createElement("a",{href:"#/"},"[log out]")):React.createElement("div",{className:"form"},React.createElement("form",{id:"login",onSubmit:this.login},"Log in:  ",React.createElement("input",{ref:"name",value:this.state.user,placeholder:"username",onChange:this.handleUser}),"  ",React.createElement("input",{type:"submit",value:"Log in"})))},handleUser:function(){var e=React.findDOMNode(this.refs.name).value;this.setState({user:e}),this.props.onChange&&this.props.onChange(e)},login:function(e){e.preventDefault();var t=React.findDOMNode(this.refs.name).value;location.hash="#/user/"+encodeURIComponent(t)},logout:function(e){e.preventDefault(),location.hash="#/"}});
"use strict";var Home=React.createClass({displayName:"Home",getInitialState:function(){return{subscriptions:[],triggers:[],publisher:"user2"}},LOCATIONS:{Almende:{latitude:51.908817,longitude:4.479589},"Ask CS":{latitude:51.920505,longitude:4.454438},"Rotterdam CS":{latitude:51.916563,longitude:4.481416},"Sense OS":{latitude:51.903598,longitude:4.45994}},render:function(){var e;return this.props.params.user&&(e=React.createElement("div",null,this.renderState(),this.renderSubscribe(),this.renderSimulate(),this.renderNotifications())),React.createElement("div",null,React.createElement(Account,{user:this.props.params.user}),e)},renderState:function(){var e=this.formatLocation(this.state.location),t=this.yesNoUnknown(this.state.driving),n=this.yesNoUnknown(this.state.onThePhone);return React.createElement("div",null,React.createElement("h2",null,"Me"),React.createElement("p",null,"The table below shows your current state."),React.createElement("table",null,React.createElement("tbody",null,React.createElement("tr",null,React.createElement("th",null,"Name"),React.createElement("td",null,this.props.params.user)),React.createElement("tr",null,React.createElement("th",null,"Location"),React.createElement("td",null,e)),React.createElement("tr",null,React.createElement("th",null,"Driving"),React.createElement("td",null,t)),React.createElement("tr",null,React.createElement("th",null,"On the phone"),React.createElement("td",null,n)))))},renderSubscribe:function(){return React.createElement("div",null,React.createElement("h2",null,"Notify me"),React.createElement("p",null,"Notify me when:"),React.createElement("div",{className:"form"},React.createElement("form",{onSubmit:this.subscribe},React.createElement("p",null,"User ",React.createElement("input",{ref:"publisher",value:this.state.publisher,onChange:this.handlePublisher})," arrives at my location. ",React.createElement("input",{type:"submit",value:"Subscribe"})))),this.renderSubscriptions())},renderSubscriptions:function(){var e=this.state.subscriptions.map(function(e){return React.createElement("div",{key:e.publisher},e.publisher," ",React.createElement("button",{onClick:this.deleteSubscription.bind(this,e.publisher)},"Remove"))}.bind(this));return React.createElement("div",null,React.createElement("h3",null,"Subscriptions"),e.length>0?e:"(none)")},renderSimulate:function(){return React.createElement("div",null,React.createElement("h2",null,"Simulate"),React.createElement("p",null,"Simulate your own state for testing purposes."),React.createElement("table",null,React.createElement("tbody",null,React.createElement("tr",null,React.createElement("th",null,"Location"),React.createElement("td",null,Object.keys(this.LOCATIONS).sort().map(function(e){return React.createElement("button",{key:e,onClick:this.saveState.bind(this,{location:this.LOCATIONS[e]})},e)}.bind(this)))),React.createElement("tr",null,React.createElement("th",null,"Driving"),React.createElement("td",null,React.createElement("button",{onClick:this.saveState.bind(this,{driving:!0})},"yes"),React.createElement("button",{onClick:this.saveState.bind(this,{driving:!1})},"no"))),React.createElement("tr",null,React.createElement("th",null,"On the phone"),React.createElement("td",null,React.createElement("button",{onClick:this.saveState.bind(this,{onThePhone:!0})},"yes"),React.createElement("button",{onClick:this.saveState.bind(this,{onThePhone:!1})},"no"))))))},renderNotifications:function(){var e=this.state.triggers.map(function(e){return React.createElement("div",{key:e.publisher,className:"notification"},React.createElement("b",null,e.publisher)," just arrived at your location. ",React.createElement("button",{className:"ok",onClick:this.deleteTrigger.bind(this,e.publisher)},"Ok"))}.bind(this));return this.prevTriggerCount=this.triggerCount,this.triggerCount=this.state.triggers.length,this.triggerCount>this.prevTriggerCount&&this.playSound(),React.createElement("div",{className:"notifications"},e)},componentDidMount:function(){this.loadState(),this.loadSubscriptions(),this.loadTriggers(),this.messageTimer=setInterval(function(){this.loadTriggers()}.bind(this),1e3),window.addEventListener("focus",this.loadTriggers)},componentWillUnmount:function(){clearTimeout(this.messageTimer),window.removeEventListener("focus",this.loadTriggers)},handlePublisher:function(e){this.setState({publisher:e.target.value})},subscribe:function(e){e.preventDefault(),this.saveSubscription(this.state.publisher)},deleteTrigger:function(e){var t=this.state.triggers.filter(function(t){return t.publisher!==e});this.setState({triggers:t}),this.deleteSubscription(e)},loadState:function(){$.ajax({url:"/api/v1/state/"+this.props.params.user,dataType:"json",type:"GET",success:function(e){e&&this.setState(e)}.bind(this),error:function(e){console.error("Error",e)}.bind(this)})},saveState:function(e){$.ajax({url:"/api/v1/state/"+this.props.params.user,dataType:"json",data:JSON.stringify(e),contentType:"application/json; charset=utf-8",type:"PUT",success:function(e){this.setState(e)}.bind(this),error:function(e){console.error("Error",e)}.bind(this)})},saveSubscription:function(e){$.ajax({url:"/api/v1/subscriptions/"+this.props.params.user+"/publisher/"+e,dataType:"json",type:"PUT",success:function(e){this.setState({subscriptions:e})}.bind(this),error:function(e){console.error("Error",e)}.bind(this)})},deleteSubscription:function(e){$.ajax({url:"/api/v1/subscriptions/"+this.props.params.user+"/publisher/"+e,dataType:"json",type:"DELETE",success:function(e){this.setState({subscriptions:e})}.bind(this),error:function(e){console.error("Error",e)}.bind(this)})},loadSubscriptions:function(){$.ajax({url:"/api/v1/subscriptions/"+this.props.params.user,dataType:"json",type:"GET",success:function(e){this.setState({subscriptions:e})}.bind(this),error:function(e){console.error("Error",e)}.bind(this)})},loadTriggers:function(){$.ajax({url:"/api/v1/triggers/"+this.props.params.user,dataType:"json",type:"GET",success:function(e){console.log("triggers",e),e.length>0&&this.loadSubscriptions(),this.setState({triggers:e})}.bind(this),error:function(e){console.error("Error",e)}.bind(this)})},formatLocation:function(e){if(!e)return"unknown";var t=this.findLocation(e),n="lat: "+e.latitude+", long: "+e.longitude;return t?""+t+" ("+n+")":n},findLocation:function(e){for(var t in this.LOCATIONS){var n=this.LOCATIONS[t];if(e.latitude===n.latitude&&e.longitude===n.longitude)return t}return null},yesNoUnknown:function(e){return e===!0?"yes":e===!1?"no":"unknown"},playSound:function(){console.log("play sound");var e=Math.random()>.1?"audio/phonering.wav":"audio/halleluj.wav",t=document.createElement("embed");t.width="0",t.height="0",t.src=e,document.body.appendChild(t),setTimeout(function(){document.body.removeChild(t)},1e4)}});
"use strict";var Login=React.createClass({displayName:"Login",render:function(){return React.createElement("div",null,React.createElement(Account,{user:this.props.params.user}))}});
"use strict";function init(){var e=ReactRouter,t=e.DefaultRoute,n=e.Route,a=React.createElement(n,{name:"app",path:"/"},React.createElement(t,{name:"home",handler:Login}),React.createElement(n,{name:"user",path:"/user/:user",handler:Home}));e.run(a,function(e){React.render(React.createElement(e,null),document.getElementById("app"))})}"complete"===document.readyState?init():window.onload=init;